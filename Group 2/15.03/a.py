...
while restart:
    ...
    while not finished:
        ...
        if keydowns[pygame.K_LEFT] and rect_x > 0:
            rect_x += -20
        elif keydowns[pygame.K_RIGHT] and rect_x + rect_width < WIDTH:
            rect_x += 20
        ...
        if control_mode == 0:
            ...
            pygame.draw.rect(
                screen, rainbow_color(color_value), (m_pos[0], rect_y, rect_width, rect_height))
